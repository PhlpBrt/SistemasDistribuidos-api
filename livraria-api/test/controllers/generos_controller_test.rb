...
class GenerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genero" do
    assert_difference('Genero.count') do
      post generos_url, params: { genero: { nome: @genero.nome, recomendacao: @genero.recomendacao } }, as: :json
    end
  ...
  test "should update genero" do
    patch genero_url(@genero), params: { genero: { nome: @genero.nome, recomendacao: @genero.recomendacao } }, as: :json
    assert_response 200
  end

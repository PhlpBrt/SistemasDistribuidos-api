...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { ano: @livro.ano, disponibilidade: @livro.disponibilidade, exemplar: @livro.exemplar } }, as: :json
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano: @livro.ano, disponibilidade: @livro.disponibilidade, exemplar: @livro.exemplar } }, as: :json
    assert_response 200
  end
